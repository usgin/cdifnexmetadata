# cdifnexmetadata — design

> **Archived design record, 2026-07-27.**
>
> Written before any code existed. Its conclusions are folded into
> [`README.md`](../README.md), which describes the system as built and
> is the document to read. This is kept because what was expected
> beforehand is worth being able to compare against what was built --
> several things here were revised by contact with real files, and the
...
src/cdifnexmetadata/
    ...
    cli.py               cdifnexmetadata <file> [-o out.jsonld] [--profile ...]
tests/
